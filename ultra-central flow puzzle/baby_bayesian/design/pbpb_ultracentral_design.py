...
FREE PARAMETERS (LHS-sampled)
  ...
  beta3  : octupole deformation             [-0.12, 0.12]
  beta4  : hexadecapole deformation         [-0.02, 0.06]
  w      : Trento nucleon width     [fm]    [0.50, 1.50]

FIXED PARAMETERS
  Nuclear: beta2=0, gamma=0, C_l=0.4 fm, C_s=-1
...
FREE_PARAMS = [
    ...
    ("beta3", -0.12, 0.12, r"$\beta_3$",               "PUZ"),
    ("beta4", -0.02, 0.06, r"$\beta_4$",               "PUZ"),
